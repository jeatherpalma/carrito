<?php 
    ...
    if((!$coneccion) && (!$login)){
    	...
    	$destino = "/public_html/img/categorias/".strtolower(utf8_encode($categoria));
    	...
    	if($subido){
            ...
            $sql = "INSERT INTO libro (nombre,descripcion, costo, paginas, imagen) 
            VALUES('$nameBokk','$descripcion','$costo','$paginas','$url')";
